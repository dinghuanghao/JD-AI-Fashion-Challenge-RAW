...
```
gloabl steps = 19327
'my_output': array([[4.46740414e-05, 3.55785907e-08, 1.00000000e+00, 1.52954854e-11,
        2.60038793e-01, 1.11924123e-03, 5.06535685e-03, 8.95808518e-01,
        1.00000000e+00, 1.61421156e-13, 1.40477969e-05, 9.41219833e-03,
        7.68098896e-14],
       [1.38628238e-03, 4.42322490e-09, 1.00000000e+00, 4.69061345e-10,
        8.83732796e-01, 1.46126866e-01, 2.66307925e-05, 5.55451848e-02,
        1.00000000e+00, 1.35432455e-11, 1.70176662e-07, 5.95490310e-05,
        2.60793785e-17],
       [9.20810521e-01, 5.90976015e-07, 1.00000000e+00, 6.05204905e-13,
        8.50127816e-01, 5.41771129e-02, 2.14858133e-07, 6.22818014e-03,
        1.00000000e+00, 2.80092660e-09, 3.96586984e-06, 3.81400264e-06,
        2.38517781e-16],
       [9.99997020e-01, 1.01053098e-03, 1.00000000e+00, 3.60749104e-11,
        1.09053388e-01, 5.32059712e-05, 5.16980737e-02, 9.51715291e-01,
        1.00000000e+00, 5.41488625e-11, 2.59379478e-04, 3.38728055e-02,
        3.15263224e-14],
       [1.77926823e-01, 1.12376962e-04, 1.00000000e+00, 6.71632279e-06,
        9.21527147e-01, 1.05350330e-01, 9.12101023e-05, 7.00532496e-01,
        1.00000000e+00, 1.67700021e-10, 5.90867102e-01, 2.75399277e-08,
        6.49783838e-11],
       [2.09893733e-01, 1.84687622e-06, 1.00000000e+00, 1.07359217e-12,
        2.48014316e-01, 2.10139412e-03, 2.95550071e-05, 9.34984311e-02,
        1.00000000e+00, 8.75646944e-10, 6.16772450e-05, 9.57738725e-04,
        2.54330409e-15],
       [1.24516636e-01, 1.65619422e-05, 1.00000000e+00, 6.84426515e-10,
        4.75188643e-01, 2.19505113e-02, 9.12080941e-05, 4.69461113e-01,
        1.00000000e+00, 1.05363629e-09, 3.42409796e-04, 2.47845401e-06,
        2.35009990e-15],
       [8.76996346e-05, 8.95500207e-09, 1.00000000e+00, 1.78739142e-11,
        5.97614050e-01, 3.38821709e-01, 1.06601647e-07, 1.51203508e-02,
        1.00000000e+00, 5.84508067e-11, 1.19066353e-05, 2.23698280e-05,
        2.43930021e-17],       
```
...
从上诉的几次预测来看，网络的输出不再是单调的两个标签为1，其他为0. f2-score从0.6逐步上升到0.7（还未做阈值搜素，做了之后可能会有所不同）。当前时freeze了预训练模型，接下来将预训练模型打开试一试（学习率进一步降低）
