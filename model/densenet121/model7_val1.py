...
def train():
    ...
    for i in range(len(model_config.epoch)):
        ...
        if i == 0:
            ...
            print("load %s" % model_config.get_weights_path(model_config.epoch[i - 1]))
    ...
    for i in range(7, model_config.epoch[-1] + 1):
        model.load_weights(model_config.get_weights_path(i))
        keras_util.evaluate_model(model, model_config.val_files, y_valid, model_config.get_weights_path(i),
                                  model_config)
