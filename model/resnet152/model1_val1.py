...
def get_model(freeze_layers=-1, lr=0.01, output_dim=1, weights=os.path.join(path.root_path, 'resnet152_weights_tf.h5')):
    base_model = resnet152.resnet152_model(resolution=model_config.image_resolution, weights_path=weights)
