...
from model.resnext.resnextNet import ResNextImageNet
...
model_config = KerasModelConfig(k_fold_file="1.txt",
                                ...
                                label_up_sampling=[5, 0, 0, 5, 0, 0, 5, 0, 0, 0, 0, 0, 5],
...
def get_model(freeze_layers=-1, lr=0.01, output_dim=1, weights="None"):
    base_model = ResNextImageNet(include_top=False, weights=weights,depth=[3, 4, 23, 3],
