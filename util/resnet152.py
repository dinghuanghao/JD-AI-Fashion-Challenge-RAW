# -*- coding: utf-8 -*-
#代码来源于 https://gist.github.com/7e2eafb149f72f4d38dd661882c554a6.git
...
def resnet152_model(resolution=224, weights_path=None):
    ...
    if K.image_dim_ordering() == 'tf':
        bn_axis = 3
        img_input = Input(shape=(resolution, resolution, 3), name='data')
    else:
        bn_axis = 1
        img_input = Input(shape=(3, resolution, resolution), name='data')
...
#         weights_path = 'C:\Users\aa531\.keras\models\resnet152_weights_th.h5'
#     else:
